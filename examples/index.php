...
<html>
    <head>
        ...
        <script>
        //    $(function(){
                new xCroller('.xcrollera');
                new xCroller('.xcrollerb');
        //    })
        </script>
    </head>
    <body>
        <section id='s1' class='xcrollera'><div><button>Overlapping</button></div></section>
        <section id='s2' class=''>
            <article>
        ...
        <section id='s3' class='xcrollerb'></section>
        <section id='s4' class=''>
            <article>
        ...
        <section id='s5' class='xcrollera'></section>
        <section id='s6' class=''>
            <article>
        ...
        <section id='s7' class='xcrollerb'></section>
        <section id="s8">
