...
<html>
    ...
    <body data-xcroller='xcroller'>
        <section id='s1' class='xcroller' data-sticky='true' data-horizontal='.3'><div><button>Overlapping</button></div></section>
        <section id='s2' class=''>
            <article>
        ...
        <section id='s3' class='xcroller' data-vertical='-25'></section>
        <section id='s4' class=''>
            <article>
        ...
        <section id='s5' class='xcroller' data-fixed='true'></section>
        <section id='s6' class=''><article>
        ...
        <section id='s7' class='xcroller' data-vertical='100' data-infinite='true'></section>
        <section id="s8">
